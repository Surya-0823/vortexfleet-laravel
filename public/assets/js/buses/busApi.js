/**
 * @file
 * Handles all API requests for the Buses Management page.
 * @license GNU
 */
...
/**
 * Submits the bus form (Add or Edit) via AJAX.
 * @param {string} url - The URL to submit to.
 * @param {FormData} formData - The form data to send.
 * @returns {Promise<object>} - The JSON response from the server.
 */
export async function submitBusForm(url, formData) {
...
/**
 * Sends an AJAX request to delete a bus.
 * @param {string} url - The delete URL.
 * @param {string} busId - The ID of the bus to delete.
 * @returns {Promise<object>} - The JSON response from the server.
 */
export async function deleteBus(url, busId) {
